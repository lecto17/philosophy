      ...
      philoArr: [
        {
          ...
          happiness:
            "당신은 <strong>다니엘과 같은 크리스천</strong>이군요!<br/><br/>악한 세상과 격리되기 보다 그 가운데서 구별되어 빛나고자 하는 당신은 현실에 타협하지 않고 하나님을 경외할 줄 아는 사람입니다!<br/><br/> 현실의 고난 가운데서도 끝까지 믿음을 지킬 때, 하나님께서 반드시 갚아주시고 은혜 베푸신다는 것은 다니엘의 시대에도 지금 우리가 사는 시대에도 똑같습니다!<br/><br/> 그렇기에 지치지 않도록 하나님께 기도하며 맡기는 습관과 풀무불 보다도 뜨거운 열정의 동역자들을 얻는 것은 어떨까요?",
          picture: "daniel.jpg",
          personInfo:
...

        {
          ...
          happiness:
            "당신은 <strong>바나바와 같은 크리스천</strong>이군요!<br/><br/> 권면, 위로의 아들이라는 뜻의 바나바는 초기 공동체에서 이방인 전도에 힘썼고 구제와 말씀전파에 열정이 있어 관계,사람을 소중히 여기며 사랑하는 사람입니다!<br/><br/> 각박한 요즘 사회에서는 관용과 너그러움을 찾기가 어려운데요, 핍박자 였던 바울의 회심을 믿어주고, 공동체와 연결시켜주고 세워주었던 바나바와 같은 노력들이 절실한 때인 것 같습니다.<br/><br/> 관계중심의 신앙관을 가진 당신, 현재 회복이 필요한 관계가 있지는 않나요? 바나바의 모습을 본받아 용납해주고 먼저 손 내밀어 보는것은 어떨까요?",
          picture: "barnaba.jpg",
          personInfo:
            "This is a wider card with supporting text below as a natural lead-in to additional content.",
        ...
        {
          id: "모세",
          sentence: "\"위대한, 만민의 리더십 모세\"",
          detail:
            "",
          happiness:
            "당신은 <strong>모세와 같은 크리스쳔</strong>이군요!<br/><br/>당신은 삶 속에서 많은 사람에게 귀감이 되고 선한 영향력을 드러내고 있군요? 뛰어난 리더십으로 공동체를 섬기고 시선을 하나님께 둘 수 있도록 돕는 일에 관심이 많습니다.<br/><br/>내 힘으로 할 수 없다고 여겨지는 일들 또한 하나님께 의탁하며 묵묵히 해내기에 약함이 강함되는 현장을 경험하곤 합니다.<br/><br/>하나님께서 맡기신 그 일이 너무 크게만 느껴지시나요? 은혜와 말씀을 기억하며 하나님께 의탁하세요. 오늘도 은혜의 현장이 허락될 것입니다.",
          picture: "moses.jpg",
          personInfo:
            "This is a wider card with supporting text below as a natural lead-in to additional content.",
...

        {
          id: "베드로바울",
          sentence:
            "\"살아도 주를 위해, 죽어도 주를 위해 베드로 & 바울\"",
          happiness:
            "당신은 <strong>베드로&바울과 같은 크리스쳔</strong>이군요! <br/><br/>당신의 생활 속에서 활활 타오르는 불꽃과 같은 모습을 볼 수 있네요!🔥 하나님께 받은 바 은혜를 기억하며 달려가지만, 가끔 하나님 앞에 넘어질 때도 있습니다. 하지만 자신의 과오를 빠르게 인정하며 다시금 하나님께 방향을 돌이키는 아름다운 사람입니다.<br/><br/> 코로나 시대 속에서 교회와 복음에 대해 점점 마음이 닫히는 요즘, 그들의 마음에 불꽃이 일어날 수 있도록 도전해보는 것은 어떨까요?",
          picture: "peterpaul.jpg",
          personInfo:
            "This is a wider card with supporting text below as a natural lead-in to additional content.",
...

        {
          ...
          sentence:
            "\"외유내강 찬양가 다윗\"",
          happiness:
            "당신은 <strong>다윗과 같은 크리스쳔</strong>이군요!<br/><br/>말씀과 진리로 무장된 당신은 때로는 고난 앞에서 작아보이지만 하나님과 동행하며 고난을 이겨내는 사람입니다!<br/><br/>또한, 하나님 찬양하기를 누구보다 사랑하여 기쁠 때나 슬플 때나 하나님을 찬양합니다. 가끔 흥을 감추지 못하지만 지금과 같이 온 마음 다해 하나님을 찬양하세요! 하나님께서 기쁘게 듣고 계십니다.<br/><br/>연약한 사람이기에, 하나님 앞에서 넘어지기도 합니다. 하지만 빠르게 자신의 과오를 인정하고 하나님께 방향을 맞추는 당신은 그리스도인입니다",
          picture: "david.jpg",
          personInfo:
            "This is a wider card with supporting text below as a natural lead-in to additional content.",
...
.type-img{ margin: 0 auto; margin-block: auto; border: 1px solid #ddd; border-radius: 5px;}
